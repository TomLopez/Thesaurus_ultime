    ...
    return Backbone.Model.extend({
      ...
      initialize: function(options){
        ...
        this.schema = {
          ...
          TAtt_Type:      {type: 'Select', title: $.i18n.t("topicAttribute_field.field_TAtt_Type"), editorClass: 'form-control', options:[{label: 'Description', val: '1', icon: null},{label: 'Fichier', val: '3', icon: null},{label: 'Image', val: '2', icon: null}]},
          TAtt_FieldValue:      {type: 'TextArea', title: $.i18n.t("topicAttribute_field.field_TAtt_FieldValue"), editorClass: 'form-control .attFieldValueLabel'},
          ...
          TTopicFile:   {
            type: 'NestedModel',
            model: ModTopicFile,
            fieldClass: 'colapsableField hidden removeButton',
            title: $.i18n.t("topicAttribute_field.field_TTopicFile"),
