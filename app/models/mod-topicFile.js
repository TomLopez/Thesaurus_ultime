...
function(Marionette, Backbone, Config) {
  ...
  return Backbone.Model.extend({
	...
	initialize: function(options){
		this.schema = {
			TTFi_FK_Att_PKID:      {type:'Number',editorAttrs:{disabled:true},editorAttrs:{disabled:true}, title: $.i18n.t('topicFile_field.field_TTFi_FK_Att_PKID'), editorClass: 'form-control'},
			...
			TTFi_Extension:      {type:'Text',editorAttrs:{disabled:true}, title: $.i18n.t('topicFile_field.field_TTFi_Extension'), editorClass: 'form-control'},
		}
	}
  });
});
