  ...
  return Backbone.Model.extend({
	...
	initialize: function(options){
		this.schema = {
			...
			TTFi_Blob:       {type:'FileUploadEditor', title: $.i18n.t('topicFile_field.field_TTFi_Blob'), editorClass: 'form-control file-container', options:{acceptedFiles:"", uploadurl: Config.servUrl + 'topicfile'}},
